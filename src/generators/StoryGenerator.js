...
import { LLMStoryGenerator } from '../core/StorySystem.js'; // Import classes
...
Return ONLY valid JSON with this structure:
{
  ...
  "pages": {
        ...
        return {
            ...
            pages: {
                ...
                "romantic_deepening": {
                    ...
                    text: "In the quiet intimacy of shared space, you discover that this connection runs deeper than mere attraction. Your companion's lips find yours in a passionate kiss. Clothes begin to fall away as desire ignites between you. The night is filled with heated passion, exploring each other's bodies with growing intensity. Every touch sends electricity through your skin as you lose yourself in pleasure.",
                    choices: [
                        { "text": "Continue the passionate encounter", "target": "intimate_scene" },
                ...
                "intimate_scene": {
                    background: "intimate_chamber",
                    text: "The room fills with sounds of passion as you surrender to desire. Skin against skin, breath mingling, you explore forbidden pleasures together. Your bodies move in perfect rhythm, building toward ecstasy. Wave after wave of pleasure crashes over you both as the night unfolds in increasingly explicit encounters. By dawn, you're both exhausted but deeply satisfied, the connection between you now unbreakable.",
                    choices: [
                        { "text": "Recover and prepare for danger ahead", "target": "combat_ambush" },
                        { "text": "Share tender moments together", "target": "love_confession" }
                    ]
                },
                "combat_ambush": {
                    background: "ambush_scene",
                    text: "Still catching your breath from the passionate night, armed assassins burst through the door! No time to dress - you grab your weapons and fight naked, adrenaline mixing with post-coital vulnerability. This is just like those intense action sequences where everything is on the line!",
                    combat: {
                        enemy: {
                            name: "Elite Assassin",
                            health: 60,
                        ...
                        victory: "victory_intimate_combat",
                        defeat: "defeat_ambush"
                    }
                },
                "victory_intimate_combat": {
                    background: "victory_aftermath",
                    text: "Breathing hard, covered in sweat and blood, you stand victorious over your attackers. Your lover looks at you with renewed desire and respect. The danger only heightened the attraction. You collapse into each other's arms once more, the thrill of survival mixing with rekindled passion.",
                    choices: [
                        { "text": "Another round of passion before continuing", "target": "intimate_scene" },
                        { "text": "Get dressed and investigate who sent them", "target": "explore_together" }
                    ]
                },
                "defeat_ambush": {
                    background: "capture_scene",
                    text: "Overwhelmed and vulnerable, you're both captured. But even in captivity, stolen glances and secret touches keep the fire burning between you. You'll escape together - nothing can break this bond.",
                    choices: [
                        { "text": "Plan your escape", "target": "start" }
                    ]
                },
                "love_confession": {
                ...
                "explore": {
                    ...
                    text: "You venture forth alone and discover new challenges. Suddenly, a dangerous creature blocks your path!",
                    choices: [
                        { "text": "Face the beast in combat", "target": "combat_beast" },
                        { "text": "Try to sneak past it", "target": "start" },
                        { "text": "Return to seek that mysterious stranger", "target": "romantic_encounter" }
                    ]
                },
                "combat_beast": {
                    background: "dark_forest",
                    text: "A fearsome beast emerges from the shadows, snarling and ready to attack!",
                    combat: {
                        enemy: {
                            name: "Shadow Beast",
                            health: 50,
                        ...
                        victory: "victory_beast",
                        defeat: "defeat_beast"
                    }
                },
                "victory_beast": {
                    background: "victory_scene",
                    text: "You strike the final blow! The beast collapses before you, defeated. You feel stronger and more confident. Gold and items are yours!",
                    choices: [
                        { "text": "Continue your adventure", "target": "explore_together" },
                        { "text": "Rest and recover", "target": "prepare" }
                    ]
                },
                "defeat_beast": {
                    background: "defeat_scene",
                    text: "The beast overpowers you! You barely escape with your life, wounded but wiser. Perhaps you should prepare better next time.",
                    choices: [
                        { "text": "Return to the tavern to recover", "target": "start" },
                        { "text": "Try again when better prepared", "target": "prepare" }
                    ]
                },
                "prepare": {
     ...
     */
    async _callClaudeApi(prompt, _systemPrompt) {
        if (!this.apiKey) {
    ...
    "page_id_1": {
      ...
      "choices": [
        ...
        if (currentPageCount < minPages) {
            ...
            const BATCH_SIZE = 50;
            const MAX_PAGES = 2000; // Increased for longer stories
